...
trip_data = {
    1: {
        ...
        "title_jp": "<ruby>成田空港<rt>なりたくうこう</rt></ruby><ruby>到着<rt>とうちゃく</rt></ruby>、<ruby>格安一般列車<rt>かくやすいっぱんれっしゃ</rt></ruby>での<ruby>新宿移動<rt>しんじゅくいด้วย</rt></ruby>＆<ruby>郊外型大型銭湯<rt>こうがいがたおおがたせんとう</rt></ruby> 🛬",
    ...
    2: {
        ...
        """,
        "rows_jp": """
            <tr><td>08:00 - 09:30</td><td>🚃 JR<ruby>湘南新宿<rt>しょう난しんじゅく</rt></ruby>ラインで<ruby>南下<rt>なんか</rt></ruby></td><td>新宿駅から湘南新宿ラインの<ruby>一般列車<rt>いっぱんれっしゃ</rt></ruby>に乗車し、鎌倉駅へ直行移動。</td><td>実費</td></tr>
    ...
    3: {
        ...
        "sento_th": "Mega Sento 3: Yura no Sato (天然温泉 湯楽ของ里)", "sento_en": "Mega Sento 3: Yura no Sato", "sento_jp": "メガ<ruby>銭湯<rt>せんとう</rt></ruby> 3：<ruby>湯楽<rt>ゆらく</rt></ruby>の<ruby>里<rt>さと</rt></ruby>",
    ...
    7: {
        ...
        "title_jp": "新宿での<ruby>休息<rt>きゅうそく</rt></ruby>タイム＆<ruby>日本庭園名湯<rt>にほんていえんめいとう</rt></ready>さやの<ruby>湯処<rt>ゆどころ</rt></ruby> 🎋",
...
def generate_html(day, lang):
    ...
    rows = d[f'rows_{lang}']
    full_rows = rows + f"""
        <tr class="highlight-pass"><td>16:30 - 19:30</td><td>♨ย️ {sento_title}</td><td>{sento_desc}</td><td>{sento_c}</td></tr>
...
<div class="container">
    ...
    <div class="day-section">
        <div class="day-title">🗓ย️ Day {day}: {date_str} | {title_str}</div>
