...
# ข้อมูลแผนการเดินทางแบบละเอียด ยิบ ชั่วโมงต่อชั่วโมง ครบ 3 ภาษา (TH, EN, JP) ไร้บั๊กคีย์ตัวแปรสลับ
trip_data = {
    1: {
        ...
        "title_jp": "成田空港到着、格安一般列車での新宿移動＆郊外型大型銭湯 🛬",
        "sento_th": "Mega Sento 1: Manten no Yu (天然温泉 満天の湯)", "sento_en": "Mega Sento 1: Manten no Yu", "sento_jp": "メガ銭湯 1：満天の湯",
        ...
        "sento_detail_jp": "広々とした人気スーパー銭湯へ。巨大な露天風呂や炭酸泉に浸かり、フライトの疲れを癒やす。地元客で大変賑わう。",
    ...
    2: {
        ...
        "title_jp": "古都鎌倉日帰り観光＆江ノ電ローカル線の海沿い車窓旅 🌊",
        "sento_th": "Mega Sento 2: Spadium Japon (スパジアムジャポン)", "sento_en": "Mega Sento 2: Spadium Japon", "sento_jp": "メガ銭湯 2：スパジアムジャポン",
        ...
        "sento_detail_jp": "一般列車とシャトルバスを乗り継ぎ、東京最大級のメガ銭湯施設へ。15種類もの多彩な大浴場を誇り、非常に活気ある雰囲気。",
    ...
    3: {
        ...
        "title_jp": "皇居散策＆郊外型大型スーパー銭湯湯楽の里 ⛩️",
        "sento_th": "Mega Sento 3: Yura no Sato (天然温泉 湯楽の里)", "sento_en": "Mega Sento 3: Yura no Sato", "sento_jp": "メガ銭湯 3：湯楽の里",
        ...
        "sento_detail_jp": "格安の一般列車で大型スーパー銭湯へ移動。広大な岩造り露天風呂や各種ジェットバスを誇り、地元客で大変賑わう。",
        ...
        "rows_jp": """
            ...
            <tr><td>10:30 - 12:30</td><td>👑 皇居外苑と二重橋の徒歩視察</td><td>有名な二重橋や、広大な濠の石垣構造など、皇居外周의土木遺構を歩いて見学。</td><td>無料</td></tr>
    ...
    4: {
        ...
        "title_jp": "秋葉原＆アメ横散策＋メガ銭湯スパジアムジャポン ⚡",
        "sento_th": "Mega Sento 4: Spadium Japon (スパジアムジャポン)", "sento_en": "Mega Sento 4: Spadium Japon", "sento_jp": "メガ銭湯 4：スパジアムジャポン",
    ...
    5: {
        ...
        "title_jp": "千葉モノレール懸垂型車両体験＆郊外型メガスーパー銭湯竜泉寺の湯 🚄",
        "sento_th": "Mega Sento 5: Ryusenji no Yu (竜泉寺の湯)", "sento_en": "Mega Sento 5: Ryusenji no Yu", "sento_jp": "メガ銭湯 5：竜泉寺の湯",
    ...
    6: {
        ...
        "title_jp": "明治神宮の杜散策＆超大型銭湯おふろcafe utatane 🌳",
        "sento_th": "Mega Sento 6: Ofuro Cafe Utatane (おふろcafe utatane)", "sento_en": "Mega Sento 6: Ofuro Cafe Utatane", "sento_jp": "メガ銭湯 6：おふろcafe utatane",
        ...
        "sento_detail_jp": "埼玉の近代的な超大型温泉施設へ。多彩な浴槽や広々としたサウナを誇り、若い世代を中心に一日中大変活気がある。",
    ...
    7: {
        ...
        "title_jp": "新宿での休息タイム＆日本庭園名湯さやの湯処 🎋",
        "sento_th": "Mega Sento 7: Sayanoyudoko (前野原温泉 さやの湯処)", "sento_en": "Mega Sento 7: Sayanoyudoko", "sento_jp": "メガ銭湯 7：さやの湯処",
        ...
        "sento_detail_jp": "都内屈指の超人気天然温泉へ。本格的な日本庭園を眺めながら、源泉かけ流しの濃い緑色の露天風呂や各種アトラクションバスを満喫。一日中非常に混雑する名店。",
    ...
    8: {
        ...
        "title_jp": "成田への拠点移動＆成田温泉華の湯で旅の締めくくり 🧳",
        "sento_th": "Mega Sento 8: Hana no Yu Narita (成田温泉 華の湯)", "sento_en": "Mega Sento 8: Hana no Yu Narita", "sento_jp": "メガ銭湯 8：華の湯 成田",
...
print("\n🚀 [SUCCESS] เคลียร์บั๊กภาษาญี่ปุ่น เรียงไทม์ไลน์ละเอียดชั่วโมงต่อชั่วโมง ครบ 27 ไฟล์แล้วมึง!")