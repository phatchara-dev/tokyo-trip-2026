...
* `tokyo_trip_2026` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `Tokyo trip 2026` - executable or bundle name on disk.
* `Tokyo trip 2026` - display name shown in window titles and about app dialogs.
